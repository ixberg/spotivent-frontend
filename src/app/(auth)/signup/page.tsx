...
const SignUp = () => {
  const [selectedRole, setSelectedRole] = useState<string>("regularUser");
      ...
      <div className="flex flex-col gap-12 py-16 px-20 bg-background-100 w-[680px] rounded-xl">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-center">
            Never miss a beat! Sign up now to explore upcoming music concerts or
            create your event
          </p>
        </div>
        <div>
          ...
          >
            <ToggleGroupItem
              value="regularUser"
              className={`flex gap-2 items-center justify-center px-5 py-6 rounded-full ${
                ...
                <Image
                  src={
                    selectedRole === "eventOrganizer"
                      ...
                      : "/icon/security-user-unselected.svg"
                  }
                  alt="user-icon"
                  width={20}
                  height={20}
        ...
        <form>
          ...
          <div className="mb-6">
            <label className="mb-2.5 block font-medium">Re-type Password</label>
            <div className="relative">
              <input
                type="password"
          ...
          <div className="mb-5">
            <input
              ...
              className="w-full cursor-pointer rounded-full border border-primary bg-primary p-4 text-black font-semibold transition hover:bg-opacity-90"
            />
          </div>
